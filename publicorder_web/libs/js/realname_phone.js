		...
		var _v = {
								...
								event: function(template, hide) {
									...
									_a.checkStuffInfoReturn({
										...
										function upDataWidthOutImage() {
											_a.createRepaiPhoneInfo(personinfo, function() {
												var setting = {
			...
			_t = {
				searchResultsList: function(data) {
					...
					html += '<p>物品名称:</p><span>' + data['ds_name'] + '</span><p>人员姓名:</p><span>' + data['ds_person_name'] + '</span><p>创建时间:</p><span>' + data['dataTime'] + '</span><div class="obsimg"></div>'
					html += '</li>'
					html = $(html);
					html.click(function() {
						...
						var option = {
							...
							success: function(result) {
								if (result.list.length == 0) {
									...
									var Ul = $('<ul class="listnumberheight" style="height:460px;"></ul>');
				...
				creatmetalpersoninfo: function(data) {
					var creatinfo = '';
					creatinfo += '<div>'
					...
					creatinfo += '</li>'
					creatinfo += '<li>'
					creatinfo += '<p>回收时间：</p><input type="text"  style="width:440px; cursor:pointer;" class="ds_date laydate-icon" onclick="laydate()" >'
					creatinfo += '</li>'
					creatinfo += '<li>'
					creatinfo += '<p>手机类型：</p><input type="text" placeholder="请输入手机类型" class="ds_type">'
					creatinfo += '</li>'
					creatinfo += '<li>'
					creatinfo += '<p>品牌：</p><input type="text" placeholder="请输入品牌" class="ds_brand">'
					creatinfo += '</li>'
					creatinfo += '<li>'
					creatinfo += '<p>手机重量：</p><input type="text" placeholder="请输入手机类型" class="ds_weight">'
					creatinfo += '</li>'
					creatinfo += '<li>'
				...
				creatmetalpersoninfo2: function(data) {
					console.log(data);
					var creatinfo = '';
					creatinfo += '<div>'
					creatinfo += '<ul class="metalinfo">'
					...
					creatinfo += '</li>'
					creatinfo += '<li>'
					creatinfo += '<p>回收时间：</p><input type="text" class="ds_date laydate-icon" style="width:440px; cursor:pointer;" value="' + (data['intoDate'] ? data['intoDate'] : '') + '"  onclick="laydate()" readonly="readonly">'
					creatinfo += '</li>'
					creatinfo += '<li>'
					creatinfo += '<p>手机类型：</p><input type="text" placeholder="请输入手机类型" class="ds_type" value="' + (data['ds_type'] ? data['ds_type'] : '') + '">'
					creatinfo += '</li>'
					creatinfo += '<li>'
					creatinfo += '<p>品牌：</p><input type="text" value="' + (data['ds_brand'] ? data['ds_brand'] : '') + '" class="ds_brand" readonly="readonly">'
					creatinfo += '</li>'
					creatinfo += '<li>'
					creatinfo += '<p>手机重量：</p><input type="text" placeholder="请输入手机类型" class="ds_weight" value="' + (data['ds_weight'] ? data['ds_weight'] : '') + '">'
					creatinfo += '</li>'
					creatinfo += '<li>'
			...
			_a = {
				...
				/*添加手机维修实名制信息*/
				createRepaiPhoneInfo: function(data, success) {
					common.POST({
						data: data,
						url: "/crm/Entities",
						success: function(result) {
